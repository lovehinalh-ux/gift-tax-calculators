...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary: 'bg-primary-500 text-white hover:bg-primary-600 hover:scale-105 active:scale-95 focus:ring-primary-200',
      secondary: 'border-2 border-primary-500 text-primary-500 hover:bg-primary-50 focus:ring-primary-200',
      ...
      danger: 'bg-red-500 text-white hover:bg-red-600 hover:scale-105 active:scale-95 focus:ring-red-200',
    }
